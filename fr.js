...
if (typeof T !== 'undefined') {
  T['fr'] = {
   ...
   'tx-hero-h1':   'Développement d\'infrastructures <em>de vente localisées</em><br>pour les fabricants chinois.',
    ...
    'page-title': 'NOLVO — Développement d\'infrastructures de vente localisées pour les fabricants chinois.',
    /* footer */
...
/* 2. Inject FR into BLOCKS (keep existing BLOCKS modifications if any) */
if (typeof BLOCKS !== 'undefined') {
  BLOCKS['sec-con-title']['fr'] = 'L\'ancienne approche<br><em>ne fonctionne plus</em>';
  BLOCKS['cc-old-items']['fr'] = `<div class="cc-item"><span class="cc-icon">⚠️</span><span class="cc-text">Frais de plateforme de 60 000 à 100 000 ¥/an en hausse constante, pour des prospects de moins en moins qualifiés</span></div>
  ...
  BLOCKS['cc-new-items']['fr'] = `<div class="cc-item"><span class="cc-icon">✅</span><span class="cc-text">Une équipe locale proactive développe activement des clients pour vous, chaque jour</span></div>
  ...
  BLOCKS['ind1-items']['fr'] = `<div class="ind-item"><span class="ind-dot"></span><span>Pièces de précision CNC</span></div>
  ...
  BLOCKS['ind2-items']['fr'] = `<div class="ind-item"><span class="ind-dot"></span><span>Matériaux de construction & décoration</span></div>
  ...
  BLOCKS['rc1-items']['fr'] = `<div class="rc-item"><span class="rb"></span><span>Fournir produits, tarifs et support technique</span></div>
  ...
  BLOCKS['rc2-items']['fr'] = `<div class="rc-item"><span class="rb"></span><span>Recruter et sélectionner les candidats commerciaux locaux</span></div>
  ...
  BLOCKS['rc3-items']['fr'] = `<div class="rc-item"><span class="rb"></span><span>Prospection active et développement des clients</span></div>
  ...
  BLOCKS['scope-yes-items']['fr'] = `<div class="scc-item"><span class="scc-mark">→</span><span>Recrutement et gestion quotidienne de l\'équipe de vente locale</span></div>
  ...
  BLOCKS['scope-no-items']['fr'] = `<div class="scc-item"><span class="scc-mark">✗</span><span>Certification produit (CE, UL, etc.)</span></div>
  ...
  BLOCKS['fit-yes-items']['fr'] = `<div class="fc-item"><span class="fc-mark">◆</span><span>Dispose d\'une expérience à l\'export mais manque de capacité de vente proactive à l\'étranger</span></div>
  ...
  BLOCKS['fit-no-items']['fr'] = `<div class="fc-item"><span class="fc-mark">✗</span><span>S\'attend à ce que NOLVO préfinance tous les coûts sans engagement de l\'usine</span></div>
  ...
  BLOCKS['pb2']['fr'] = ['Support complet de NOLVO', 'Vous n\'êtes pas seul. NOLVO fournit des outils de vente, une formation produit, une aide à la proposition et un suivi continu pour maximiser votre taux de réussite.'];
